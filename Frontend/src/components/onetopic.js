  ...
  return (
    <div>
      <div className={styles.titleContainer}>
        <img src="/back.png" className={styles.backForward}/>
        <div className={styles.title}>TITLE</div>
        <img src="/forward.png" className={styles.backForward}/>
      </div>
      <div className={styles.oneTopicContainer}>
        <div  className={styles.ForumTopic}>
          <img src="/pictures/fort.jpg" className={styles.picture}></img>
          <div className={styles.likesCommentsContainer}>
            <div>1<img className={styles.likeIcons} src="/likes2.png"></img></div>
            <div>2<img className={styles.likeIcons} src="/dislikes2.png"></img></div>
            <div>3<img className={styles.likeIcons} src="/comment2.png"/></div> {/*should we add comment section to picture_posts or get the amount of comments from comments table?*/}
          </div>
        </div>
      ...
      <form className={styles.commentForm}>
        <label for="comment">Write new comment:</label><br/>
